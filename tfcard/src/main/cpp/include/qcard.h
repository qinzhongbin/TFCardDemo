...
*******************************************************************************/
QCARD_API int
QCard_EnumSpecifiedTypeStoreHandle(QHANDLES *phStoreHandles, unsigned long ulOpearteType);
...
*******************************************************************************/
QCARD_API int
QCard_WaitForDevEvent(char *pcDriverName, unsigned long *pulDevNameLen, unsigned long *pulEvent);
...
*******************************************************************************/
QCARD_API int
QCard_GetDriverName(QHANDLE hStoreHandle, char *pcDriverName, unsigned long *pulDevNameLen);
...
*******************************************************************************/
QCARD_API void
QCard_SetLog(void (*cb)(int level, char *msg), int lverror, int lvwarn, int lvinfo, int lvdebug,
             int lvtrace);
...
* Return         : 成功返回0,其它返回错误码
*******************************************************************************/
QCARD_API int QCard_ExportCertificate(QHANDLE hStoreHandle, char *pcAppName, char *pcContainerName,
...
*******************************************************************************/
QCARD_API int
QCard_RSASignData(QHANDLE hStoreHandle, char *pcAppName, char *pcContainerName, char *pcUserPin,
                  unsigned long *pulUserPinRetry,
                  unsigned char *pucData, unsigned long ulDataLen, unsigned char *pucSignature,
...
* Return         : 成功返回0,其它返回错误码
*******************************************************************************/
QCARD_API int QCard_SM2SignSM3Data(QHANDLE hStoreHandle, char *pcAppName, char *pcContainerName,
                                   unsigned char *pcData, unsigned long ulDataLen,
                                   char *pcUserPin, unsigned long *ulUserPinRetry,
                                   char *pcSignature, unsigned long *pulSignatureLen);
...
* Return         : 成功返回0; 其它值为错误码;
*******************************************************************************/
QCARD_API int QCard_ReadAuthSynFlag(QHANDLE hStoreHandle, char *pcOtherStoreId, char *pcAppName,
                                    char *pcContainerName,
...
* Return         : 成功返回0; 其它值为错误码;
*******************************************************************************/
QCARD_API int QCard_AuthSynFlag(QHANDLE hStoreHandle, char *pcOtherStoreId, char *pcAppName,
                                char *pcContainerName,
...
* Return         : 成功返回0; 其它值为错误码;
*****************************************************/
QCARD_API int QCard_AuthSynFlagKeyInit(QHANDLE hStoreHandle, char *pcOtherStoreId, char *pcFlag,
                                       unsigned long ulAlgId, QCard_BLOCKCIPHERPARAM KeyParam,
                                       char *pcAppName, char *pcContainerName, char *pcPin,
                                       unsigned long ulSafeTactics, KEYHANDLE *phKeyHandle);
...
QCARD_API int QCard_GetAuthSynBlokcKeyId(QHANDLE hStoreHandle, char *pcOtherStoreId, char *pcFlag,
                                         char *pcAppName, char *pcContainerName, char *pcPin,
                                         unsigned long ulSafeTactics, unsigned char **pucBlockKey,
...
*****************************************************/
QCARD_API int
QCard_ClientKeyInit(QHANDLE hStoreHandle, char *pcCheckCode, char *pcFlag, unsigned long ulAlgId,
...
*******************************************************************************/
QCARD_API int
QCard_LocalKeyInit(QHANDLE hStoreHandle, unsigned long ulAlgId, QCard_BLOCKCIPHERPARAM KeyParam,
                   char *pcAppName, char *pcContainerName, char *pcPin, unsigned long ulSafeTactics,
                   KEYHANDLE *phKeyHandle);
...
* Return         : 成功返回0; 其它值为错误码;
*****************************************************/
QCARD_API int QCard_ConsultKeyInit(QHANDLE hStoreHandle, unsigned char *pucWrapedData,
                                   unsigned long ulWrapedDataLen, unsigned long ulAlgId,
                                   QCard_BLOCKCIPHERPARAM KeyParam,
                                   char *pcAppName, char *pcContainerName, char *pcPin,
                                   unsigned long ulSafeTactics, KEYHANDLE *phKeyHandle);
...
*******************************************************************************/
QCARD_API int
QCard_ExternalKeyInit(QHANDLE hStoreHandle, unsigned char *pucKey, unsigned long ulKeyLen,
                      unsigned long ulAlgId, QCard_BLOCKCIPHERPARAM KeyParam,
                      KEYHANDLE *phKeyHandle);
...
* Return         : 成功返回0; 其它值为错误码;
*******************************************************************************/
QCARD_API int QCard_ExportKey(QHANDLE hStoreHandle, KEYHANDLE hKeyHandle, unsigned char *pucKey,
                              unsigned long *pulKeyLen);
...
* Return         : 成功返回0; 其它值为错误码;
*******************************************************************************/
QCARD_API int QCard_Encrypt(QHANDLE hStoreHandle, KEYHANDLE hKeyHandle, unsigned char *pucData,
                            unsigned long ulDataLen, unsigned char *pucEncryptedData,
                            unsigned long *pulEncryptedLen);
...
*******************************************************************************/
QCARD_API int
QCard_Decrypt(QHANDLE hStoreHandle, KEYHANDLE hKeyHandle, unsigned char *pucEncryptedData,
              unsigned long ulEncryptedLen, unsigned char *pucData, unsigned long *pulDataLen);
...
*******************************************************************************/
QCARD_API int
QCard_OnlineChargingKey(QHANDLE hStoreHandle, char *pcAppName, char *pcContainerName, char *pcPin,
                        unsigned long ulMinKeyQuantity);
...
* Return         : 成功返回0; 其它值为错误码;
*******************************************************************************/
QCARD_API int QCard_ProxyOnlineChargingKey(QHANDLE hStoreHandle, char *pcProxyAddr, char *pcAppName,
                                           char *pcContainerName, char *pcPin,
                                           unsigned long ulMinKeyQuantity);
...
*******************************************************************************/
QCARD_API int
QCard_GetSysTemId(QHANDLE hStoreHandle, char *pcAppName, char *pcContainerName, char *pcSystemId);
...
*******************************************************************************/
QCARD_API int
QCard_RequestCTSKey(char *pcAddr, char *pcStoreId, char *pcSystemId, unsigned char **pucKey,
...
*******************************************************************************/
QCARD_API int
QCard_RequestCTSKeyByApp(char *pcAddr, char *pcStoreId, char *pcAppName, char *pcConName,
                         unsigned long ulSoftKeyLen,
                         unsigned char *pucKey, unsigned char *pucSoftKey, char **pcFlag,
                         char *pcCheckCode);
...
*******************************************************************************/
QCARD_API int
QCard_QueryKey(QHANDLE hStoreHandle, char *pcStoreId, char *pcAppName, char *pcContainerName,
               unsigned long *pulKeyTotalLen, unsigned long *pulKeyUsedLen);
...
*******************************************************************************/
QCARD_API int
QCard_QueryLargeKey(QHANDLE hStoreHandle, char *pcStoreId, char *pcAppName, char *pcContainerName,
                    unsigned long long *pullKeyTotalLen, unsigned long long *pullKeyUsedLen);
...
*******************************************************************************/
QCARD_API int
QCard_GetNegotiateMode(QHANDLE hStoreHandle, char *pcSystemId, unsigned int *puiNegotiateMode);
...
* Return         : 成功返回0; 其它值为错误码;
*******************************************************************************/
QCARD_API int QCard_GetNegotiateModeApp(QHANDLE hStoreHandle, char *pcAppName, char *pcConName,
                                        unsigned int *puiNegotiateMode);
...
* Return         : 成功返回0,其它返回错误码
*******************************************************************************/
QCARD_API int QCard_GetContianerType(QHANDLE hStoreHandle, char *pcAppName, char *pcContainerName,
                                     unsigned long *pulContainerType);
...
*******************************************************************************/
QCARD_API int
QCard_WriteAudit(QHANDLE hStoreHandle, char *pcAppName, char *pcContainerName, char *pcOperateType,
                 char *pcOperateObj, unsigned long ulResultCode, char *pcDiscription);
...
* Return         : 成功返回0,其它返回错误码
*******************************************************************************/
QCARD_API int QCard_VerifyAppPIN(QHANDLE hStoreHandle, char *pcAppName, char *pcUserPin,
                                 unsigned long *pulUserPinRetry);
...
*******************************************************************************/
QCARD_API int
QCard_StartSyncAuditThread(QHANDLE *phStoreHandle, char *pcAppName, char *pcContainerName,
                           char *pcUserPin);
...
*******************************************************************************/
QCARD_API void
QCard_SetProxyServerAddress(unsigned int uiSetProxy, const char *pcProxyServerAddress,
                            const char *pcProxyServerUserPassword);
