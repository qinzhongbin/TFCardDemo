...
SKF_FUN_INFO(SKF_CUSTOM_ImportSymmKey,(HCONTAINER hContainer,BYTE *pbWrapedData, ULONG ulWrapedLen));
SKF_FUN_INFO(SKF_CUSTOM_ImportSessionKey,(HCONTAINER hContainer,ULONG ulSysAlgId,ULONG ulAlgId, BYTE *pbWrapedData, ULONG ulWrapedLen, HANDLE *phKey));
...
#define SKF_DEF_FUN_T(name) __PASTE(P_,name)	name
	...
	SKF_DEF_FUN_T(SKF_CUSTOM_ImportSymmKey);
	SKF_DEF_FUN_T(SKF_CUSTOM_ImportSessionKey);
